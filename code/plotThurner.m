%% plot the average paper quality when referee consists of 100 percent correct referee
MAX_TIMESTEP = 500;
...
fig = figure();
set(gca, 'FontSize', 16);
load('../data/Thurner/100_0_0_0/acc_num_100_0_0_0', 'acc_num');
load('../data/Thurner/100_0_0_0/avg_quality_100_0_0_0', 'avg_quality');
subplot(2, 1, 1);
plot(1:MAX_TIMESTEP, avg_quality);
title('(a)');
xlabel('publication rounds');
...
xlim([0 500]);
ylim([0 250]);
saveas(fig, '../doc/figure/Thurner/acc_num_100_0_0_0.eps', 'psc2');
...
%% plot the average quality with network
f_random = 0;
f_rational = 0:0.1:0.7;
...
%% plot the average quality when the journal raise the accept standard
f_random = 0;
f_rational = 0:0.1:0.7;
alpha = [1.0, 0];
